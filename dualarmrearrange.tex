...
\author{Rahul Shome$^1$ \and Kiril Solovey$^2$ \and Jingjin Yu$^1$ \and Kostas Bekris$^1$ \and Dan Halperin$^3$}
...
\blfootnote{$^1$Rutgers University, NJ, USA, $^2$Stanford University, CA, USA, and $^3$Tel Aviv University, Israel.
