...
%\newtheorem{obs}{Theorem}
%\newtheorem{deff}{Theorem}
%\newtheorem{corr}{Theorem}


%\newtheorem{lemma}[lem]{Lemma}
%\newtheorem{observation}[obs]{Observation}
%\newtheorem{corollary}[corr]{Corollary}
...
\newcommand{\revisions}[1]{{\color{blue}#1}}
\newcommand{\dual}{\revisions{two}}
\newcommand{\Dual}{\revisions{Two}}
